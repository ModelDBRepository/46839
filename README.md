...
Expand archive file. Use mknrndll (windows, mac) or nrnivmodl (unix) to compile the mod files. Start nrngui and load the mosinit.hoc file to see a couple of traces from figure 6A in the paper.

Clicking on the Kinetics, Cell, or Electrodes buttons allow the changing of these simulation parameters.
